...
17	Перчатки тактические	700	/gloves.png	{{"Тип продукта",Перчатки},{Ткань,"Микрофайбер, неопрен, пластик"},{Текстура,Вязание},{"Вес ткани","0,180г."},{Цвет,"Подбор цвета"},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	tacticgloves1669156642057
\.
...
2	Подсумок под аптечки	{{"Тип продукта","Сумка под аптечки"},{"Вес ткани","0,25кг"},{Ткань,"600D нейлон"},{Размер,15*21*11см},{Цвет,"Черный, красный, оранжевый"},{"Стойкость цвета","4-5 класс"}}	\N	700	/medical-subkit.png	medkit1669157008761
\.
