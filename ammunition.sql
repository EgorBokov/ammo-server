...
11	Очки баллистические	1100	glasses.png	{{"Тип продукта",Очки},{Материал,"АБС, ТПУ, ПК"},{"Цвет рамы","Зеленый, черный, комуфляж"},{"Стойкость цвета","4-5 класс"}}	\N	glasses1669156510186	\N
13	Спальный мешок	2500	sleepbag.png	{{"Тип продукта","Спальный мешок"},{Структура,Соарер},{Масса,2000г.},{"Техничекие характеристики","(Д*Ш) 180*30"},{"Стойкость цвета","4-5 класс"}}	\N	bag1669156537822	\N
1	Термобелье	3670	termosuit1.png	{{"Тип продукта",Тремобелье},{Ткань,Полиэстер},{Текстура,Вязание},{"Вес ткани","160-180 г/м2"},{Цвет,Зеленый/Черный},{Стойкость,"4-5 класс"}}	{S,M,L,XL,XXL}	thermo11669155856846	\N
2	Термобелье	2000	termosuit2.png	{{"Тип продукта",Тремобелье},{Ткань,"65% нейлон, 25% полиэстер, 10% спандекс"},{Текстура,Вязание},{"Вес ткани",220г.},{Цвет,Зеленый/Черный},{Стойкость,"4-5 класс"}}	{S,M,L,XL,XXL}	thermo21669156196838	\N
3	Форма полицейская	6000	policesuit.png	{{"Тип продукта","Полицейская форма"},{"Ткань рукавов и брюк","ТС 65/35"},{Текстура,РИП-СТОП/САРЖА},{"Вес ткани","190-200 г/м2"},{Цвет,Зеленый/Черный},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	policeform1669156216778	\N
4	Костюм лягушки	6700	frogsuit.png	{{"Тип продукта","Костюм лягушки"},{"Ткань рукавов и брюк","ТС 65/35"},{Текстура,РИП-СТОП/САРЖА},{"Вес ткани","210-230 г/м2"},{"Текстура основной ткани","Триктожная хлопчатобумажная ткань"},{Цвет,Зеленый/Черный},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	frogsuit1669156363415	\N
6	Униформа АКУ	5100	akusuit.png	{{"Тип продукта","Униформа АКУ"},{Ткань,"ТС 65/35"},{Текстура,РИП-СТОП/САРЖА},{"Вес ткани","210-230 г/м2"},{"Текстура основной ткани","Триктожная хлопчатобумажная ткань"},{Цвет,Зеленый/Черный},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	akusuit1669156400177	\N
7	Шапка флисовая	300	beanie.png	{{"Тип продукта","Шапка флисовая"},{Ткань,Полиэстер},{Текстура,Вязание},{"Вес ткани","0,05г."},{Цвет,"Подбор цвета"},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	hat1669156421199	\N
8	Носки зимние	200	socks.png	{{"Тип продукта","Носки зимние"},{Ткань,Хлопок},{Текстура,Вязание},{"Вес ткани","0,18г."},{Цвет,"Подбор цвета"},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	socks1669156436235	\N
10	Тактическая сумка	750	tacticalbag.png	{{"Тип продукта",Сумка},{Ткань,"Оксфорд 800D"},{Цвет,"Черный, камуфляж СР, песочный"},{"Стойкость цвета","4-5 класс"}}	\N	tactbag1669156493639	\N
9	Берцы, обувь зимняя	2500	foots.png	{{"Тип продукта",Обувь},{Ткань,"Двухсторонний флис"},{"Вес ткани","0,4кг."},{Цвет,"Черный, зеленый, бежевый"},{"Стойкость цвета","4-5 класс"}}	{39,40,41,42,43,44,45,46}	shoes1669156469990	\N
14	Мультитул	2200	multitool.png	{{"Тип продукта",Мультитул},{"Стойкость цвета","4-5 класс"}}	\N	mulitool1669156563189	\N
15	Наколенники/Налокотники	700	kneedefender.png	{{"Тип продукта","Зашитное снаряжение"},{Вес,"0,35кг."},{Материал,"Пластик, губка, ткань"},{Цвет,"Черный, зеленый, серый"},{"Защитные части","Локоть, колено"}}	\N	forleg11669156582908	\N
5	Униформа БДУ	5500	bdusuit.png	{{"Тип продукта","Униформа БДУ"},{Ткань,"ТС 65/35"},{Текстура,РИП-СТОП/САРЖА},{"Вес ткани","210-230 г/м2"},{"Текстура основной ткани","Триктожная хлопчатобумажная ткань"},{Цвет,Зеленый/Черный},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	bdusuit1669156384247	\N
12	Балаклава	330	balaklava.png	{{"Тип продукта",Балаклава},{Ткань,Полиэстер},{"Вес ткани","0,05г."},{Цвет,"Черный, армейский, коричневый"},{"Стойкость цвета","4-5 класс"}}	\N	balaclava1669156523938	\N
16	Наколенники/Налокотники	700	kneedefender2.png	{{"Тип продукта","Зашитное снаряжение"},{Вес,"0,35кг."},{Материал,"Пластик, губка, ткань"},{Цвет,"Черный, зеленый, серый"},{"Защитные части","Локоть, колено"}}	\N	forleg21669156598738	\N
17	Перчатки тактические	600	gloves.png	{{"Тип продукта",Перчатки},{Ткань,"Микрофайбер, неопрен, пластик"},{Текстура,Вязание},{"Вес ткани","0,180г."},{Цвет,"Подбор цвета"},{"Стойкость цвета","4-5 класс"}}	{S,M,L,XL,XXL}	tacticgloves1669156642057	700
\.
